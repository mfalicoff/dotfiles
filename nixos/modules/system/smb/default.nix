...
in
{
  options.smb = {
    ...
    shares = mkOption {
      ...
      default = {
        appdata = { remote = "//${cfg.server}/appdata"; mountPoint = "/mnt/appdata"; };
        backups = { remote = "//${cfg.server}/backups"; mountPoint = "/mnt/backups"; };
        documents = { remote = "//${cfg.server}/documents"; mountPoint = "/mnt/documents"; };
        downloads = { remote = "//${cfg.server}/downloads"; mountPoint = "/mnt/downloads"; };
        media = { remote = "//${cfg.server}/media"; mountPoint = "/mnt/media"; };
        isos = { remote = "//${cfg.server}/isos"; mountPoint = "/mnt/isos"; };
      };
